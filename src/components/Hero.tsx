  ...
  return (
    <section id="hero" className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Framed Engineering Workbench Container */}
        <div className="mt-12 lg:mt-14">
          <div className="relative rounded-2xl border border-white/[0.12] bg-[#0c0e14]/95 shadow-[0_0_35px_rgba(0,0,0,0.22)] p-4 sm:p-6 transition-all duration-300">
            {/* Top Controller Header */}
            <div className="flex flex-wrap items-center justify-between gap-3 pb-4 mb-4 border-b border-white/[0.08]">
              <div className="flex items-center gap-2.5">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-xs font-mono-code font-semibold text-slate-300 uppercase tracking-wider">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-mono-code transition-all cursor-pointer ${
                    heroMode === 'architecture'
                      ? 'bg-white/[0.08] text-white border border-white/[0.16] shadow-sm'
