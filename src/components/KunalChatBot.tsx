...
export function ChatBotFloatingTrigger({
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-40 group flex items-center gap-2 pl-2.5 pr-3 py-2 rounded-full bg-[#0d1117] hover:bg-[#131822] border border-emerald-500/30 hover:border-emerald-400/60 shadow-[0_8px_30px_rgba(0,0,0,0.6)] backdrop-blur-md transition-all duration-300 hover:scale-105 cursor-pointer"
    >
      <div className="relative flex items-center justify-center">
        <div className="w-7 h-7 rounded-full bg-emerald-500/20 border border-emerald-500/40 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-500/30 transition-colors">
      ...
      <div className="flex flex-col text-left">
        <div className="flex items-center gap-1">
          <span className="font-display font-semibold text-[11px] text-white group-hover:text-emerald-300 transition-colors">
            Ask Kunal AI
          </span>
...
export function ThemeToggle({
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 left-6 z-40 flex h-10 w-10 items-center justify-center rounded-full border shadow-[0_8px_24px_rgba(0,0,0,0.25)] backdrop-blur-md transition-colors cursor-pointer ${
        isLightMode
          ? 'border-amber-400/40 bg-white text-amber-600 hover:bg-amber-50'
          : 'border-white/[0.14] bg-[#0d1117] text-slate-300 hover:bg-[#131822] hover:text-white'
      }`}
    >
