...
import { KunalChatBot, ChatBotFloatingTrigger, ThemeToggle } from './components/KunalChatBot';
...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-[#08090c] text-slate-100 font-sans selection:bg-emerald-500/30 selection:text-emerald-200 ${isLightMode ? 'light-mode' : ''}`}>
      {/* Navigation */}
      <Navbar
